...
#| warning: false
#| echo: false
df = conn_table.make_assess_table("Focal Species", "Available Spawning Habitat", "% of total linear spawning habitat accessible", 25, 50, 75, api.connect_spawn)
df
...
**Comments:** Indicator rating definitions are based on the consensus decisions of the planning team, including the decision not to define Fair. The current status is based on the CWF Structure Prioritization Model output, which is current as of March 2022.
