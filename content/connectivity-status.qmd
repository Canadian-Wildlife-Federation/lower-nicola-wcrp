...
In the Lower Nicola River watershed, `r reticulate::py$spawning_connected_km` km of spawning habitat are currently connected to the ocean and `r reticulate::py$spawning_disconnected_km` km are disconnected from it. This means that `r reticulate::py$spawning_connected_pct`% of the `r reticulate::py$spawning_total_km` km of total habitat is connected.  

In the Lower Nicola River watershed, `r reticulate::py$rearing_connected_km` km of rearing habitat are currently connected to the ocean and `r reticulate::py$rearing_disconnected_km` km are disconnected from it. This means that `r reticulate::py$rearing_connected_pct`% of the `r reticulate::py$rearing_total_km` km of total habitat is connected. 
...
In the Lower Nicola River watershed, `r reticulate::py$potentially_disconnect_spawning_structures` structures potentially disconnect spawning habitat. Of these, `r reticulate::py$priority_barriers` are identified as barriers in need of rehabilitation (priority barriers), `r reticulate::py$non_actionable_spawning` are identified as barriers that do not warrant rehabilitation (non-actionable), and `r reticulate::py$further_field_assessment_spawning` require further field assessment. 

In the Lower Nicola River watershed, `r reticulate::py$potentially_disconnect_rearing_structures` structures potentially disconnect rearing habitat. Of these, `r reticulate::py$priority_barriers` are identified as barriers in need of rehabilitation (priority barriers), `r reticulate::py$non_actionable_rearing` are identified as barriers that do not warrant rehabilitation (non-actionable), and `r reticulate::py$further_field_assessment_rearing` require further field assessment. 
...
```{r}
#| label: table-7
#| tbl-cap: "Table 7: Labelled structures in the Habitat Accumulation Curve (Figure 1), their rank, and upstream spawning and rearing habitat for Pacific Salmon and steelhead in The Lower Nicola River watershed. Habitat gain (averaged across sets) represents the amount (km) of habitat upstream of that structure to the next structure and depicts the potential gain in habitat if passage at that structure was restored."
#| warning: false
#| echo: false
source("Rscripts/table_formatting.R")
library("flextable")
