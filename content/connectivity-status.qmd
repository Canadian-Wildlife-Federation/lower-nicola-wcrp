...
df = pd.DataFrame({"Target Species":["Target Species"," "],
                   ...
                   "Fair":["25-50%"," "],
                   "Good":["51-75%"," "],
                   "Very Good":[">75%", api.watershed_connectivity("SPAWNING")[0]]
                   })
...
df = pd.DataFrame({"Target Species":["Anadromous Salmonids"," "],
                   ...
                   "Fair":["25-50%"," "],
                   "Good":["51-75%"," "],
                   "Very Good":[">75%", api.watershed_connectivity("REARING")[0]]
                   })
...
df = pd.DataFrame({"Goal #": [1,2,3],
                   "Goal": ["By 2031, the total area of groundwater-serviced off-channel thermal refuge accessible to anadromous salmonids will increase by 6,000 m2 within the Lower Nicola River watershed. ",
                            "By 2025, the % of total linear spawning habitat accessible to anadromous salmonids will not decrease below "+str(api.watershed_connectivity("SPAWNING")[0])+"% within the Lower Nicola River watershed.  ",
                            "By 2031, the % of total linear rearing habitat accessible to anadromous salmonids will increase from "+str(api.watershed_connectivity("REARING")[0])+"% to 90% within the Lower Nicola River watershed." ]
                    })
