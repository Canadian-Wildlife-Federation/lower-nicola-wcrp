...
```{python echo=FALSE}
#| label: tbl-ranked
#| tbl-cap: "Habitat Accumulation Summary Table"
#| warning: false
#| echo: false
...
display_df['Upstream Habitat Rank'] = display_df['Upstream Habitat Rank'].astype(int)
display_df['Avg Habitat Gain'] = display_df['Avg Habitat Gain'].map("{:.2f}".format)
display_df['Avg Habitat Gain'].dtype
