...
## Strategy 2: Crossing Remidiation {-}
```{python echo=FALSE}
#| label: tbl-S2
#| tbl-cap: "Strategy 2"
#| warning: false
...
![Theory of change developed by the planning team for the actions identified under Strategy 1: Lateral Barrier Remediation in the Lower Nicola River watershed.](images/flowchart-lat-bar-rem.png){#fig-stra1}
